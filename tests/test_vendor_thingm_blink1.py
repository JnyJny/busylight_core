...
from busylight_core.vendors.thingm._blink1 import (
    State, Action, LEDS, Report,
    ReportField, ActionField, RedField, GreenField, BlueField,
    PlayField, StartField, StopField, CountField, FadeField, LedsField, LinesField
)
...
class TestThingMBlink1State:
    ...
    def test_state_methods_clear_previous(self):
        ...
        for method in methods_to_test:
            ...
            assert state.report == Report.One
            assert state.action in [Action.FadeColor, Action.SetColorPattern, 
                                  Action.SaveColorPatterns, Action.PlayLoop]
